...
function agregarProyecto(titulo, descripcion, imagen, link, pro) {
...
function proyect(){
    ...
    "https://cafeteria-django.onrender.com");
...
function mostrarDatos(hasta){
    ...
    for (let proyecto = 0; proyecto < hasta && proyecto < listProyectos.length; proyecto++) {
        if (listProyectos[proyecto].pro.length != "") {
            console.log(listProyectos[proyecto].pro);
            prod = '<a href="'+listProyectos[proyecto].pro+'" class="btn btn-outline-primary">Sitio web <i class="bi bi-box-arrow-up-right ms-1"></i></a>'
        }else{
            prod = "";
        };
        html += '<div class="col-sm-4 mb-3 mb-sm-0 fade-in">'+
                '<div id="'+listProyectos[proyecto].titulo+'" class="card mb-3" data-bs-theme="dark" alt="Tarjeta '+listProyectos[proyecto].titulo+'">'+
                    ...
                    '<div class="card-body text-info" alt="imagen de '+listProyectos[proyecto].titulo+'">'+
                        ...
                        '</a>'+
                    '</div>'+
                    '<div class="card-footer text-center" alt="Botones para obtener mas informacion y link al proyecto '+listProyectos[proyecto].titulo+'">'+
                        ...
                        '<a href="'+listProyectos[proyecto].link+'" class="btn btn-outline-primary">GitHub <i class="bi bi-github ms-1"></i></a> '+
                        prod+
                    '</div>'+
                '</div>'+
            '</div>'
